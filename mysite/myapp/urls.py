...
from myapp.views import UserLoginView, UserLogout, RegistrationView, ProductListView, ProductUpdateView, OrderViewList, \
    ReturnOfGoodRedirectView, CancelListView, ReturnPositionRedirectsView, BuyingCreateView, ProductCreateView
...
urlpatterns = [
    ...
    path('order/return/', ReturnOfGoodRedirectView.as_view(), name='return'),
